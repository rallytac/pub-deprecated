...
/** @addtogroup limits Engage Engine Limits
 *  @{
 */        
 ...
 */
ENGAGE_API int engageOpenCertStore(const char * _Nonnull fileName, const char * _Nonnull passwordHexByteString);
 ...
 * needs not contain a private key if no prvate key is to be associated.
 * 
 * No events are generated by this API call.
 * 
 * @param id The identifier by which the certificate and private key will be referenced
