    ...
    public JSONObject makeTemplate()
    {
        ...
        try
        {
            ...
            if(_useRP)
            {
                ...
                rallypoint.put(Engine.JsonFields.Rallypoint.address, _rpAddress);
                rallypoint.put(Engine.JsonFields.Rallypoint.port, _rpPort);
    ...
    public boolean parseTemplate(String json)
    {
        ...
        try
        {
            ...
            // Rallypoint (using default certificate)
            {
                ...
                if(rallypoint != null)
                {
                    _rpAddress = rallypoint.getString(Engine.JsonFields.Rallypoint.address);
                    _rpPort = rallypoint.getInt(Engine.JsonFields.Rallypoint.port);
                    _useRP = true;
                }
