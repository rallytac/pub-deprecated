...
import com.rallytac.engagereference.core.DatabaseMission;
...
import com.rallytac.engagereference.core.MissionDatabase;
...
public class DeveloperTestActivity extends AppCompatActivity
{
    ...
    {
        // Parse the developer testing mission
        String tmp = Utils.getStringResource(this, com.rallytac.engagereference.core.R.raw.development_testing_mission_template);
        ActiveConfiguration ac = new ActiveConfiguration();
        if(!ac.parseTemplate(tmp))
        {
            Toast.makeText(this, "Cannot parse the developer testing mission database", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(database == null)
        {
            Toast.makeText(this, "Cannot open the mission database", Toast.LENGTH_SHORT).show();
            return;
        }

        // Find the mission.  If it's already there, there's nothing to do
        ...
        if( database.addOrUpdateMissionFromActiveConfiguration(ac) )
        {
            ...
            Toast.makeText(this, "Installed the developer testing mission", Toast.LENGTH_SHORT).show();
        }
        else
        {
            Toast.makeText(this, "Failed to install the developer testing mission", Toast.LENGTH_SHORT).show();
        }
    }
